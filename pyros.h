...
PyrosList *Pyros_Add_Full(PyrosDB *pyrosDB, char *filePaths[], size_t filec,
                          ...
                          void *callback_data);
int Pyros_Add_Tag(PyrosDB *pyrosDB, const char *hash, char *tags[],
                  size_t tagc);
...
void Pyros_Remove_Tag_From_Hash(PyrosDB *pyrosDB, const char *hash,
                                const char *tag);
void Pyros_Remove_All_Tags_From_Hash(PyrosDB *pyrosDB, const char *hash);
...
void Pyros_Merge_Hashes(PyrosDB *pyrosDB, const char *masterHash,
                        const char *hash2, int copy_tags_to_maser_file);
